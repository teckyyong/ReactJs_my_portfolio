...
import sunway_college from '../../assets/sunway_college.jpg';
import university from '../../assets/university.jpg';
// import kumon from '../../assets/kumon.jpg'; // add later if available
  ...
  const educationHistory = [
    {
      ...
      logo: university,
      achievements: [
        "Current CGPA: 3.67 (WAM: 74%)",
        "Relevant: Algorithms & Data Structures, Databases, Statistics/R",
        "Tools: Python, Java, R, SQL, Jupyter"
      ]
    },
    {
      number: "2",
      ...
      program: "Canadian International Matriculation Programme (CIMP)",
      logo: sunway_college,
      achievements: [
        "Average: 87%",
        "Strengthened foundation in mathematics & computing"
      ]
    },
    {
      number: "3",
      year: "2022",
      institution: "Catholic High School, PJ",
      program: "SPM",
      logo: catholic,
      achievements: [
        "8A’s including A+ in Mathematics and Additional Mathematics"
      ]
    },
    {
      number: "4",
      year: "2021",
      institution: "Kumon",
      program: "Mathematics Completion",
      logo: null, // replace with `kumon` once you add a logo
      achievements: [
        "Algebra II, Geometry, Trigonometry, Pre-Calculus, Calculus"
      ]
    }
  ];
        ...
        {educationHistory.map((item, index) => (
          <div key={index} className="education-wrapper">
            <div className="education-column">
              ...
              <h2>{item.number}. {item.institution}</h2>
              <h3>{item.program} — {item.year}</h3>
              <ul>
